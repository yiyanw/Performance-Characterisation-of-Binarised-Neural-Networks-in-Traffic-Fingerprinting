...
from util.utility import LoadDataNoDefCW
...
# show_info(model, "images/DF/", 'quant_conv2d', print_result=False)
# show_info(model, "images/DF/", 'quant_conv2d_1', binarize_weights=True)
# show_info(model, "images/DF/", 'quant_conv2d_2', binarize_weights=True)
# show_info(model, "images/DF/", 'flatten', result_type=('output'), print_result=False)
# show_info(model, "images/DF/", 'quant_dense')
